...
export class UserRegistrationData {
    ...
    constructor({ email, nickname, password }: { email: string, nickname: string, password: string }) {
        ...
        //     throw new InvalidUserValueObjectParamsException('Invalid password. It should contain at least 8 characters, 1 uppercase, 1 lowercase, 1 number and 1 symbol.');
        // }
